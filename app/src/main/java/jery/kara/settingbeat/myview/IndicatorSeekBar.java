...
public class IndicatorSeekBar extends View {
    ...
    public IndicatorSeekBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (attrs != null) {
            TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.IndicatorSeekBar);
            ...
            try {
                ...
                rangeCount = a.getInt(
                        R.styleable.IndicatorSeekBar_rangeCount, DEFAULT_RANGE_COUNT);
                filledColor = a.getColor(
                        R.styleable.IndicatorSeekBar_filledColor, DEFAULT_FILLED_COLOR);
                emptyColor = a.getColor(
                        R.styleable.IndicatorSeekBar_emptyColor, DEFAULT_EMPTY_COLOR);
                barHeightPercent = a.getFloat(
                        R.styleable.IndicatorSeekBar_barHeightPercent, DEFAULT_BAR_HEIGHT_PERCENT);
                barHeightPercent = a.getFloat(
                        R.styleable.IndicatorSeekBar_barHeightPercent, DEFAULT_BAR_HEIGHT_PERCENT);
                slotRadiusPercent = a.getFloat(
                        R.styleable.IndicatorSeekBar_slotRadiusPercent, DEFAULT_SLOT_RADIUS_PERCENT);
                sliderRadiusPercent = a.getFloat(
                        R.styleable.IndicatorSeekBar_sliderRadiusPercent, DEFAULT_SLIDER_RADIUS_PERCENT);
                currentIndex = a.getInt(R.styleable.IndicatorSeekBar_currentSlot, 0);
            } finally {
                a.recycle();
                sa.recycle();
            }
